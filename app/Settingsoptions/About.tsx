...
export default function ReportsPage() {
  ...
  <SafeAreaView style={styles.container}>
    <View style={styles.header}>
      ...
      <Text style={styles.headerTitle}>ِAbout Us</Text>
      <View style={{ width: 40 }} />
        </View>
        <View>
          <Text>
            # Skin Disease Detection App Using Artificial Intelligence
...
### Smart Diagnosis with Images

The app allows users to take a picture directly with the camera or select one from their phone's gallery. Artificial intelligence algorithms process the image within seconds, providing diagnostic results with a confidence level for each possible diagnosis, along with a list of the closest possible diseases similar to the patient's condition.

### Comprehensive Medical Database

The application contains a rich medical database that includes detailed information on more than one hundred skin diseases, including the causes, symptoms, and complications of each disease, along with available treatment methods and approved medical recommendations. The database also provides guidelines for preventing common skin diseases.

### Monitoring Condition Progress
The monitoring feature allows users to document their skin condition over time. They can store multiple images of the affected area and track its response to treatment, while receiving alerts and reminders for treatment appointments and follow-up appointments. This is of great medical value, especially for patients with chronic skin conditions.

### Connecting with Doctors

The application provides a platform for direct communication with dermatologists through an online medical consultation system. Users can share initial diagnostic results with the doctor and receive their guidance. This feature saves time for both the patient and the doctor and contributes to enhancing the quality of healthcare provided.
...
It is worth noting that the AI ​​models used in the application have undergone intensive training under the supervision of a team of dermatologists, ensuring high accuracy in diagnostic results. The application works efficiently on both iOS and Android operating systems, with web access also available for maximum inclusivity.

## Diseases Detected by the Application
...
Despite the application's promising potential, several challenges and limitations should be considered. Technically, the accuracy of the diagnosis is affected by the quality of the captured image, the intensity of the ambient lighting, and its clarity. Furthermore, like any artificial intelligence system, the application is not without the possibility of diagnostic errors, especially in unusual or rare skin conditions. From a medical perspective, it is crucial to emphasize that the application is not a substitute.
          </Text>
        </View>
    </SafeAreaView>
    </>
