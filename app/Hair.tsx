...
const eyeColors = [
          ...
          <Pressable onPress={() => router.back()} style={styles.backBtn}>
            <Ionicons name="arrow-back" size={28} color="black" />
                  ...
                  <View style={styles.topRow}>
                    {!selectedColor && (
                      <TouchableOpacity onPress={() => router.push("/Continue")}>
  ...
  >
    ...
    <View
      style={[
        styles.optionCard,
        selectedColor === item.name && styles.optionSelected,
      ]}
    >
      ...
      <View
        style={[
          styles.radio,
          selectedColor === item.name && styles.radioActive,
        ]}
      />
    </View>
  </TouchableOpacity>
