...
import { NOTIFICATIONS_ENABLED_KEY } from '../Screensbar/notificationsData'; // ← adjust path
...
export default function SettingsPage() {
    ...
    // ── Load profile + notifications setting on every focus ───
    useFocusEffect(
        React.useCallback(() => {
            ...
            const loadData = async () => {
                try {
                    ...
                    // Notifications toggle — default true if never set
    ...
    const SettingsRow: React.FC<SettingsRowProps> = ({
        icon, iconColor = '#004F7F', label, onPress, rightElement, isLast = false,
    }) => (
        <TouchableOpacity
        ...
        >
            ...
            {rightElement ?? (onPress ? <Ionicons name="chevron-forward" size={18} color="#C5E3ED" /> : null)}
        </TouchableOpacity>
    );
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalBox}>
                        ...
                        <View style={styles.modalButtons}>
                            <TouchableOpacity style={styles.stayButton} onPress={() => setLogoutModalVisible(false)} activeOpacity={0.8}>
                    ...
                    <SettingsRow
                        ...
                        rightElement={
                            <Switch
                                ...
                                onValueChange={handleNotificationsToggle}  // ← updated
...
const styles = StyleSheet.create({
    ...
    modalBox: {
        backgroundColor: '#FFFFFF', borderRadius: 24, paddingVertical: 32, paddingHorizontal: 28,
        width: '82%', alignItems: 'center', shadowColor: '#000',
        shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.15, shadowRadius: 16, elevation: 10,
    },
    ...
    modalTitle: { fontSize: 16, fontWeight: '600', color: '#1F2937', textAlign: 'center', lineHeight: 24, marginBottom: 8 },
    modalEmail: { fontSize: 14, fontWeight: '700', color: '#004F7F', textDecorationLine: 'underline', marginBottom: 28 },
    modalButtons: { flexDirection: 'row', gap: 12, width: '100%' },
    stayButton: { flex: 1, backgroundColor: '#004F7F', borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
    ...
    profileCard: {
        ...
        marginBottom: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 3,
    },
    profileAvatar: { width: 52, height: 52, borderRadius: 26, backgroundColor: '#C5E3ED', justifyContent: 'center', alignItems: 'center', marginRight: 14, overflow: 'hidden' },
    profileAvatarImage: { width: 52, height: 52, borderRadius: 26 },
    profileAvatarText: { fontSize: 22, fontWeight: '700', color: '#004F7F' },
    profileInfo: { flex: 1 },
    ...
    card: { backgroundColor: '#FFFFFF', borderRadius: 16, marginBottom: 20, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 3 },
    ...
    settingsLabel: { flex: 1, fontSize: 15, color: '#1F2937', fontWeight: '500' },
    ...
    cameraButton: {
        position: 'absolute', top: -26, alignSelf: 'center', width: 60, height: 60, borderRadius: 30,
        backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center',
        borderWidth: 3, borderColor: '#C5E3ED', shadowColor: '#000',
        shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.12, shadowRadius: 6, elevation: 6,
    },
